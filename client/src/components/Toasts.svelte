...
.toast-close:hover {
    color: var(--white1);
    box-shadow: -5px 0 5px #FFFFFF40, 5px 0 5px #FFFFFF40, 0 -5px 5px #FFFFFF40, 0 5px 5px #FFFFFF40;
...
<div class="toasts-overlay">
    {#each toasts as toast}
        <div class="toasts-popup panel-border panel-glass"
            ...
            <div class="toast-title">
                ...
                <div class="toast-close" on:click={() => dismissToast(toast.id)}>
                    X
                </div>
