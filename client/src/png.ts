...
export function decodePNG(img: ArrayBuffer): PNGChunk[] {
    ...
    if (view.getUint32(0) !== PNG_MAGIC_1
        || view.getUint32(4) !== PNG_MAGIC_2) {
...
; (window as any).debugTestPNG = testPNG
//; (window as any).debugTestCRC = crc32
// debugTestCRC(new DataView(new Uint8Array([0x48, 0x65, 0x6a]).buffer), 0, 3).toString(16) === '342512ce'
