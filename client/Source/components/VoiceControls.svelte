...
.voice-control-mute:hover,
.voice-control-deafen:hover {
    fill: var(--blue2);
}
...
<div class="voice-controls">
    ...
    <button class="voice-control-hangup" on:click={hangupVoice}>
        <Icon icon={hangup} size="24" />
    </button>
    <button class="voice-control-mute" on:click={toggleSelfMute}>
        <Icon icon={voice.selfMute ? micOff : micOn} size="24" />
    </button>
    <button class="voice-control-deafen" on:click={toggleSelfDeafen}>
        <Icon icon={voice.selfDeafen ? volumeOff : volumeOn} size="24" />
    </button>
    <button class="voice-control-camera" on:click={toggleCamera}>
